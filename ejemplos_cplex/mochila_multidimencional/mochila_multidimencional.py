...
class MKsolver:
    ...
    def set_problem(self, path_archivo, tiempo_limite, gap, num_nucleos=None):
        ...
        self.prob.parameters.mip.tolerances.mipgap.set(gap)
         # Establecer el número de núcleos si se especifica
        if num_nucleos is not None:
            self.prob.parameters.threads.set(num_nucleos)
    ...
    def solve(self, solution_file="solution.xml"):
        ...
        self.prob.solution.write(solution_file)
...
if __name__ == "__main__":
    solver = MKsolver()
    path_archivo = "/home/roko/cplex/ejemplos_cplex/mochila_multidimencional/datos/gk08.dat"
    tiempo_limite = 100 # Segundos
    gap = 0.00 # Tolerancia 
    num_nucleos = 4  # Número de núcleos a usar (puedes ajustarlo)

    
    solver.set_problem(path_archivo, tiempo_limite, gap, num_nucleos)
